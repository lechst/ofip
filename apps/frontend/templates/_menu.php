<ul class="menu_main">
    ...
    <li class="menu_main_box box_1"><a href="#"><span>Czym jest OFIP?</span></a></li>
    <li class="menu_main_box box_2"><a href="#"><span>Konferencja</span></a>
        <ul>
    ...
    <li class="menu_main_box box_3"><a href="#"><span>Tydzień Obywatelski</span></a>
        <ul>
    ...
    <li class="menu_main_box box_4"><a href="#"><span>Piknik</span></a>
        <ul>
    ...
    <li class="menu_main_box box_5"><a href="#"><span>Archiwum OFIPów</span></a>
        <ul>
