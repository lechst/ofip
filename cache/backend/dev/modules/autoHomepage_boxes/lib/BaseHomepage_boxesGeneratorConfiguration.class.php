...
abstract class BaseHomepage_boxesGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%container_nr%% - %%menu_category_id%% - %%is_active%% - %%title%% - %%content%% - %%image_id%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'container_nr',  2 => 'menu_category_id',  3 => 'is_active',  4 => 'title',  5 => 'content',  6 => 'image_id',);
  }
