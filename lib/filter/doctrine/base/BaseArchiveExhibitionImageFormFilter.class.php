...
/**
 * ArchiveExhibitionImage filter form base class.
 *
 * @package    ofip
 * @subpackage filter
 ...
 */
abstract class BaseArchiveExhibitionImageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archive_exhibition_image_filters[%s]');
