...
/**
 * CafeteriaProgram filter form base class.
 *
 * @package    ofip
 * @subpackage filter
 ...
 */
abstract class BaseCafeteriaProgramFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cafeteria_program_filters[%s]');
