...
/**
 * ConcertProgram filter form base class.
 *
 * @package    ofip
 * @subpackage filter
 ...
 */
abstract class BaseConcertProgramFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('concert_program_filters[%s]');
