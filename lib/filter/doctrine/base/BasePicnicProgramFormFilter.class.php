...
/**
 * PicnicProgram filter form base class.
 *
 * @package    ofip
 * @subpackage filter
 ...
 */
abstract class BasePicnicProgramFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('picnic_program_filters[%s]');
