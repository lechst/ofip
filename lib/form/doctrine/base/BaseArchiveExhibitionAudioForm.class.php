...
/**
 * ArchiveExhibitionAudio form base class.
 *
 * @method ArchiveExhibitionAudio getObject() Returns the current form's model object
 *
 * @package    ofip
 * @subpackage form
 ...
 */
abstract class BaseArchiveExhibitionAudioForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'audio_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Audio'), 'required' => false)),
      'order_nr'   => new sfValidatorInteger(),
      'content'    => new sfValidatorString(),
    ));

    $this->widgetSchema->setNameFormat('archive_exhibition_audio[%s]');
