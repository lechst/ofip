...
/**
 * ArchiveExhibitionImage form base class.
 *
 * @method ArchiveExhibitionImage getObject() Returns the current form's model object
 *
 * @package    ofip
 * @subpackage form
 ...
 */
abstract class BaseArchiveExhibitionImageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archive_exhibition_image[%s]');
