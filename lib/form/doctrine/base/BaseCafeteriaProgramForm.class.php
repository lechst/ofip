...
/**
 * CafeteriaProgram form base class.
 *
 * @method CafeteriaProgram getObject() Returns the current form's model object
 *
 * @package    ofip
 * @subpackage form
 ...
 */
abstract class BaseCafeteriaProgramForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cafeteria_program[%s]');
