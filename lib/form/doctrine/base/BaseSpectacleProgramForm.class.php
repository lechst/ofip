...
/**
 * SpectacleProgram form base class.
 *
 * @method SpectacleProgram getObject() Returns the current form's model object
 *
 * @package    ofip
 * @subpackage form
 ...
 */
abstract class BaseSpectacleProgramForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('spectacle_program[%s]');
